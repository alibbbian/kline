    ...
    value: function registerMouseEvent() {
      __WEBPACK_IMPORTED_MODULE_7_jquery___default()(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_7_jquery___default()("#chart_overlayCanvas").mousemove(function (e) {
          ...
          var x = (e.clientX - r.left) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
          var y = (e.clientY - r.top) * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio();
          var mgr = __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance;
      ...
      __WEBPACK_IMPORTED_MODULE_6_jquery___default()(document).ready(__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.G_HTTP_REQUEST = __WEBPACK_IMPORTED_MODULE_6_jquery___default.a.ajax({
        ...
        success: function success(res) {
          if (__WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.G_HTTP_REQUEST) {
            res = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.filterData(res);
    ...
    value: function Draw(context) {
      ...
      for (var n in gradations) {
        ...
        gridRects.push({
          x: left,
          y: y,
          w: 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
          h: 1 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio()
        });
        gridRects.push({
          x: right - 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
          y: y,
          w: 6 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio(),
          h: 1 * __WEBPACK_IMPORTED_MODULE_2__chart_manager__["a" /* ChartManager */].instance.getPixelRatio()
        });
